                    ...
                    <div className="flex min-h-full items-center justify-center p-4 text-center">
                        ...
                        >
                            <Dialog.Panel className="w-1/2 transform overflow-hidden rounded-2xl bg-white 
                                ...
                                >
                                    Crear <GradientTextDefault>Historia de usuario</GradientTextDefault>
                                </Dialog.Title>
                                <div className="mt-8 flex flex-col gap-3 w-98">
                                    <div className="flex flex-row gap-6">
                                        ...
                                        <div className="flex flex-col w-1/3">
                                            <label className="text-sm text-gray-600" htmlFor="duty_manager">Encargado</label>
                                    ...
                                    <div className="flex flex-row gap-6">
                                        <div className="flex flex-col w-2/3">
                                            <label className="text-sm text-gray-600" htmlFor="history">Historia de usuario</label>
                                            <input id="history" className="rounded-lg border px-2 py-2 active:border" />
                                        </div>
                                        <div className="flex flex-col w-1/3">
                                            <label className="text-sm text-gray-600" htmlFor="status">Estado</label>
                                            <select id="status"
                                                className="h-full p-2 bg-white w-full text-sm rounded-lg border focus:border-gray-300 border-gray-300">
                                                <option selected>
                                                    Desarrollador
                                    ...
                                    <div className="flex flex-row gap-6">
                                        <div className="flex flex-col w-2/3">
                                            ...
                                            <textarea id="description" className="rounded-lg border p-4 active:border"></textarea>
                                        </div>

                                        <div className="flex flex-col w-1/3">
                                            <label className="text-sm text-gray-600" htmlFor="artefact">Artefacto</label>
                                    ...
                                    <div className="flex flex-row pr-6">
                                        <div className="flex flex-row w-2/3 gap-3">
                                            <div className="flex flex-col w-full">
                                                <label className="text-sm text-gray-600" htmlFor="artefact">Fecha inicial</label>
                                                <input id="artefact" className="rounded-lg border px-2 py-2 active:border" />
                                            </div>
                                            <div className="flex flex-col w-full">
                                                <label className="text-sm text-gray-600" htmlFor="artefact">Fecha final</label>
                                                <input id="artefact" className="rounded-lg border px-2 py-2 active:border" />
                                            </div>
                                        </div>
                                    </div>
