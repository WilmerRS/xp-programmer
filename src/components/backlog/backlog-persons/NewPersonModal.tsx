                    ...
                    <div className="flex min-h-full items-center justify-center p-4 text-center">
                        ...
                        >
                            <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-8 text-left align-middle border transition-all">
                                ...
                                >
                                    Añadir <GradientTextDefault>Persona al proyecto</GradientTextDefault>
                                </Dialog.Title>
                                <div className="mt-8 flex flex-col gap-3">
                                    ...
                                    <div>
                                        <label className="text-sm text-gray-600" htmlFor="rol">Rol</label>
                                        <select id="rol" className="block p-2 bg-white w-full text-sm rounded-lg border focus:border-gray-300 border-gray-300">
                                            <option selected>
                                                Desarrollador
                                            </option>
                                            <option value="US">United States</option>
